/* Vamos criar uma listagem com alguns personagens de Rick and Morty, 
a documentação completa da api que vamos utilizar pode ser encontrada 
[aqui](https://rickandmortyapi.com/documentation/#rest).
...
const atualizaPaginacao = (info) => {
  ...
  if (info.prev) {anterior.onclick = async () => {
